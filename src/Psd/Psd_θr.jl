...
module psdThetar
	...
	export PSD_2_θr_FUNC, OPTIMIZE_PSD_2_θr, PSD_2_θr
		...
		#       PSD -> θr 
		# =========================================
			function PSD_2_θr_FUNC(∑Psd::Matrix, hydroPsd::Main.hydroStruct.KOSUGI, iZ::Int, param; Psd_2_θr_Size=param.psd.Psd_2_θr_Size, Psd_2_θr_α1=param.psd.Psd_2_θr_α1, Psd_2_θr_α2=param.psd.Psd_2_θr_α2)
