...
module paths
	...
	#		FUNCTION : PATHS
	# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	function PATH(opt, PathData_SoilWater, SiteName_Soilwater)
		...
		# =============================================================
         ...
         path.inputSoilwater.KsModelClass          = Path_Soilwater_Data * path.inputSoilwater.KsModelClass
		...
		#		CONVERT_SOILWATER
		# =============================================================
			if opt.run.ChangeHydroModel
				Path_ConvertSoilWater = Path_Home * "INPUT/Data_SoilWater/" * SiteName_Soilwater * "/" * "ChangehydroModel/"
