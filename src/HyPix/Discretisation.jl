...
module discretisation
	...
	# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		function DISCRETISATION(Nz::Int64, Z::Vector{Float64})
			Z_CellUp = fill(0.0::Float64, Nz)
			Znode    = fill(0.0::Float64, Nz)
			ΔZ       = fill(0.0::Float64, Nz)
			ΔZ_⬓    = fill(0.0::Float64, Nz)
			ΔZ_Aver  = fill(0.0::Float64, Nz)
			ΔZ_W     = fill(0.0::Float64, Nz)
		...
		return discret = DISCRET(Nz, Z_CellUp, Znode, ΔZ, ΔZ_⬓, ΔZ_Aver, ΔZ_W)
	...
	"""
		function DISCRETISATION_AUTO(Layer, optionHypix, paramHypix; N_Layer::Int64, Zlayer::Vector{Float64}, θini_or_Ψini)
		...
		return Layer₀, Nz, Z, θini_or_Ψini_Cell
