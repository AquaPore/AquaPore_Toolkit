...
module pathsHypix
	...
	@option mutable struct PATHYPIX
      ...
      Table_θΨ              ::String
		...
		Plot_Heatmap_YearMonth::String
		Plot_Heatmap_MonthCombine::String
		Vegetation::String
	...
	# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		function PATH_HYPIX(Path_Hypix::String, PathPathHypix::String, ProjectHypix::String, SiteName₀::SubString{String})
			...
			# HYPIX OUTPUT TABLE
               ...
               pathHypix.Table_θaverage        = Path_Hypix_Table  *  pathHypix.ScenarioName * "_"* pathHypix.Table_θaverage
               pathHypix.Table_Se              = Path_Hypix_Table  *  pathHypix.ScenarioName * "_"* pathHypix.Table_Se
               pathHypix.Table_θZₐᵥₑᵣ          = Path_Hypix_Table  *  pathHypix.ScenarioName * "_"* pathHypix.Table_θZₐᵥₑᵣ
					pathHypix.Table_Statistic       = Path_Hypix_Table  *  pathHypix.ScenarioName * "_"* pathHypix.Table_Statistic

					Path_OutputHypixHighLevel = Path_Hypix * "\\data\\OUTPUT\\Hypix\\" * ProjectHypix * "\\" 

					pathHypix.Table_Performance     = Path_OutputHypixHighLevel  * pathHypix.Table_Performance
				...
				# HYPIX PLOT
					Path_Hypix_Plot = Path_OutputHypix * "/Plots/" 	
						...
						pathHypix.Plot_Heatmap_YearMonth    = Path_Hypix_Plot * pathHypix.ScenarioName  * "_" * pathHypix.Plot_Heatmap_YearMonth
						pathHypix.Plot_Heatmap_MonthCombine = Path_Hypix_Plot * pathHypix.ScenarioName  * "_" * pathHypix.Plot_Heatmap_MonthCombine
