module climate
	...
	# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		function CLIMATE(clim, optionHypix)
         ...
         ∑PrThroughfall_Climate = fill(0.0::Float64, clim.N_Climate)
         ...
         Temp                   = fill(0.0::Float64, clim.N_Climate)
            ...
            ∑PrThroughfall_Climate[1] = 0.0::Float64
            ...
            Temp[1]                   = 0.0::Float64
			 ...
			 for iT = 2:clim.N_Climate
               ...
               ∑PrThroughfall_Climate[iT]  = ∑PrThroughfall_Climate[iT-1] + clim.Pr[iT]  # Cumulate Pr
		...
		return ∑Pet_Climate, ∑PrThroughfall_Climate, ∑T_Climate, N_∑T_Climate, Temp
