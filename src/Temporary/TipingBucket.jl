...
# module tipingBucket
    ...
    Option_BackwardForward = :Forward # <:Backwards> collect ∑PrThroughfall between 7h00_8h00; <:Forward> collect cumulative  ∑Prbetween between 8h00_9h00.
    ...
    function TIPING_BUCKET()
        ...
        for iFileName in FileName
            ...
            # COMPUTE CUMULATIVE PR
                ∑PrThroughfall = fill(0.0::Float64, N_Climate)
                ∑PrThroughfall[1] = Pr[1]
                for iT=2:N_Climate
                    ∑PrThroughfall[iT] = ∑PrThroughfall[iT-1] + Pr[iT]
                end # iT=1:N_Climate
            ...
            # GETTING DATA WITH MATCH DATA_HOURLY
                ...
                for iThourly = 1:N_Hourly
                    while  Date[iT_Tiping] ≤ Date_Hourly[iThourly] && iT_Tiping ≤ N_Climate-1
                        ∑Pr_Hourly[iThourly] = ∑PrThroughfall[iT_Tiping]
                        iT_Tiping += 1
